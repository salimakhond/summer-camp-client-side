...
const AllUsers = () => {
    ...
    const handleMakeAdmin = (user) => {
        fetch(`https://summer-cump-school-server.vercel.app/users/admin/${user._id}`, {
            method: 'PATCH',
        })
            .then((res) => res.json())
            .then((data) => {
    ...
    const handleMakeInstructor = (user) => {
        fetch(`https://summer-cump-school-server.vercel.app/users/instructor/${user._id}`, {
            method: 'PATCH',
        })
            .then((res) => res.json())
            .then((data) => {
    ...
    const handleDelete = (user) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://summer-cump-school-server.vercel.app/users/${user._id}`, {
                    method: 'DELETE',
